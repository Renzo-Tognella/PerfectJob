...
const CATEGORIES: Category[] = [
  { id: '1', name: 'Tecnologia', jobCount: 1240, icon: '💻' },
  { id: '2', name: 'Dados', jobCount: 856, icon: '📊' },
  { id: '3', name: 'Design', jobCount: 643, icon: '🎨' },
  { id: '4', name: 'Marketing', jobCount: 521, icon: '📢' },
  { id: '5', name: 'Vendas', jobCount: 489, icon: '🤝' },
  { id: '6', name: 'RH', jobCount: 312, icon: '👥' },
];
